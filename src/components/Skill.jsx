...
function Skill() {
    const skills = [
      ...
      { logo: "💻", name: "React", description: "Building web apps" },
      { logo: "💻", name: "HTML/CSS", description: "Building web apps" },
    ...
    return (
      <div className="p-8">
        <h2 className="text-left text-xl font-bold text-white mb-4">Skills</h2>
        <div className="grid grid-cols-3 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          {skills.map((skill, index) => (
            <div key={index} className="flex text-left items-center bg-dark text-white p-4 rounded-md shadow-md w-full">
